"""
File: sarsaTrain.py
Description: Trains a model using SARSA method
...
class sarsaTrainer:    
    ...
    def save_q_values(self):
        ...
        with open(".sarsa/training_data/q_table.json", "w") as file:
    ...
    def train(self):
            ...
            while True:
                ...
                if done:
                    ...
                    if total_reward > highest_score:
                        ...
                        with open("./sarsa/training_data/highest_score.txt", "w") as f:
        ...
        with lock:  # Using the lock as a context manager ensures it's released properly
            np.save(f"./sarsa/training_data/best_q_table_{formatted_time}.npy", self.Q)
            # self.save_q_values()
        self.env.close()
