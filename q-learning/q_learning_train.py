...
class QLearning:
    ...
    def load_q_values(self):
        try:
            with open("../AI-Flappy-Bird/q-learning/training_data/q_values.json", "r") as file:
    ...
    def load_training_data(self):
        ...
        try:
            with open("../AI-Flappy-Bird/q-learning/training_data/training_values.json", "r") as file:
    ...
    def save_q_values(self):
        ...
        with open("../AI-Flappy-Bird/q-learning/training_data/q_values.json", "w") as file:
    ...
    def save_training_data(self):
        ...
        with open("../AI-Flappy-Bird/q-learning/training_data/training_values.json", "w") as file:
