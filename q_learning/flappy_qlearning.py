"""
File: flappy_qlearning.py
Description: General script for running training and running of Q-Learning agents
...
PLAYERS_LIST = (
    (
        './q_learning/images/redbird-upflap.png',
        './q_learning/images/redbird-midflap.png',
        './q_learning/images/redbird-downflap.png',
    ),
)

BACKGROUNDS_LIST = (
    './q_learning/images/background-day.png',
    './q_learning/images/background-night.png',
)

PIPES_LIST = (
    './q_learning/images/pipe-green.png',
    './q_learning/images/pipe-red.png',
)
...
def main(train=True):
    global Agent
    if train:
        from q_learning.q_learning_train import QLearning
    else:
        from q_learning.q_learning_run import QLearning
    ...
    IMAGES['numbers'] = (
        pygame.image.load('./q_learning/images/0.png').convert_alpha(),
        pygame.image.load('./q_learning/images/1.png').convert_alpha(),
        pygame.image.load('./q_learning/images/2.png').convert_alpha(),
        pygame.image.load('./q_learning/images/3.png').convert_alpha(),
        pygame.image.load('./q_learning/images/4.png').convert_alpha(),
        pygame.image.load('./q_learning/images/5.png').convert_alpha(),
        pygame.image.load('./q_learning/images/6.png').convert_alpha(),
        pygame.image.load('./q_learning/images/7.png').convert_alpha(),
        pygame.image.load('./q_learning/images/8.png').convert_alpha(),
        pygame.image.load('./q_learning/images/9.png').convert_alpha()
    )

    IMAGES['gameover'] = pygame.image.load('./q_learning/images/gameover.png').convert_alpha()
    IMAGES['message'] = pygame.image.load('./q_learning/images/message.png').convert_alpha()
    IMAGES['base'] = pygame.image.load('./q_learning/images/base.png').convert_alpha()
